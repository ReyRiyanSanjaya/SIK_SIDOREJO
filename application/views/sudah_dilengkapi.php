        ...
        <div class="container-lg">
            <div class="row justify-content-center">
                <div class="col-md-10 col-lg-8">
                    ...
                    <!-- Heading -->
                    <h1 class="display-3 text-center mb-4 mt-6 text-primary-light "
                        style="text-align: center !important;">
                        MOHON MENUNGGU PENERIMAAN BANSOS
                    </h1>
					<iframe style="margin-left:-40%; margin-top:-10%; width:600px; height: 600px; position:absolute; top:0;" src="https://embed.lottiefiles.com/animation/87317"></iframe>
                    <!-- Divider -->
                    <hr class="hr-sm bg-primary mt-6 mb-6 mx-auto">
                    <!-- Text -->
                    <p
                        class="fs-lg text-center text-muted">
                        Mohon menunggu proses penerimaan dan verifikasi Bansos!.                
                    </p>
