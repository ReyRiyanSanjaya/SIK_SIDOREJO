 	...
 	<div class="container-lg">
 		<div class="row justify-content-center">
 			<div class="col-md-10 col-lg-8 text-center text-white">
 				...
 				<!-- Preheading -->
 				<h6 class="text-uppercase text-warning mb-5 mt-8">
 					Profil
 				</h6>
 				...
 				<!-- Text -->
 				<p class="fs-lg">
 					Sistem Informasi Kependudukan Kelurahan Sidorejo Kecamatan Medan Tembung
 				</p>
 ...
 <!-- POSTS -->
 <section class="pt-10 pt-md-12" style="margin-top: -5% !important;">
 	<div class="container-lg">
 		<div class="row mt-n6">
 			<div class="col-md-4 mt-10">
 				...
 				<div class="card card-sm rounded-top-start rounded-bottom-end lift lift-lg mt-6">
 					...
 					<div class="card-body">
 						...
 						<!-- Text -->
 						<p class="fs-sm mb-4">
 							Visi dan Misi Kelurahan Sidore Kecamatan Medan Tembung
 						</p>
 						...
 						<div class="d-flex align-items-center">
 							...
 							<div class="avatar avatar-xs">
 								<img class="avatar-img rounded-circle" src="<?php echo base_url('asset/gambar/pakde.png') ?>" alt="...">
 							</div>
 						...
 						<!-- Link -->
 						<a class="stretched-link" href="<?php echo base_url('home/visi'); ?>"></a>
 			...
 			<div class="col-md-4">
 				...
 				<div class="card card-sm rounded-top-start rounded-bottom-end lift lift-lg mt-6">
 					...
 					<div class="card-body">
 						...
 						<!-- Text -->
 						<p class="fs-sm mb-4">
						 Struktur Organisasi Pemerintahan Kelurahan Sidorejo Kecamatan Medan Tembung
 						</p>
 						...
 						<!-- Link -->
						 <a class="stretched-link" href="<?php echo base_url('home/struktur'); ?>"></a>
 			...
 			<div class="col-md-4 mt-10">
 				...
 				<div class="card card-sm rounded-top-start rounded-bottom-end lift lift-lg mt-6">
 					...
 					<div class="card-body">
 						...
 						<!-- Text -->
 						<p class="fs-sm mb-4">
 							Peta Kelurahan Sidorejo Kecamatan Medan Tembung
 						</p>
 						...
 						<!-- Link -->
						 <a class="stretched-link" href="<?php echo base_url('home/peta'); ?>"></a>
 		...
 		<div class="row">
 			<div class="col-12">
 				...
 				<div class="card card-lg rounded-top-start rounded-bottom-end lift lift-lg">
 					<div class="row gx-0">
 						<div class="col-md-6 bg-cover rounded-top-start my-n2" style="background-image: url(<?php echo base_url('asset/gambar/harya.png') ?>); background-position: center right;">

 							<!-- Image (placeholder) -->
 							<img class="img-fluid invisible" src="<?php echo base_url('asset/gambar/harya.png') ?>" alt="...">
 						...
 						<div class="col-md-6">
 							...
 							<div class="card-body">
 								...
 								<!-- Text -->
 								<p class="mb-4">
 									Program ini dibuat untuk membantu pelayanan administarasi kelurahan Sidorejo Hilir, kami mahasiswa UMA berupaya mengefisiensi dan optimasi pelayanan dari kelurahan SIDOREJO. Kami berharap website ini dapat bekerja dengan baik dan bermanfaat sebagaimana mestinya.
 								</p>
