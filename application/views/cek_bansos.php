    ...
    <div class="carousel-inner" data-aos="fade-in" data-aos-delay="350">
        <div class="carousel-item active">
            ...
            <div class="carousel-caption d-none d-md-block">
                ...
                <p>Daftarkan keluargamu untuk mendapatkan bantuan sosial tahun 2022</p>
            </div>
...
<div class="custom-pencarian" id="custom-pencarian" data-aos="fade-in" data-aos-delay="250">
    ...
    <div class="container-fluid justify-content-center">
        <p>Silahkan daftar terlebih dahulu untuk mengecek apakah anda penerima bantuan sosial <a
                href="<?php echo base_url('auth/registrasi') ?>"><span class="badge bg-primary" data-aos="fade-in"
                    data-aos-delay="350">Disini</span></a></p>
        <hr>
    </div>
</div>
<hr>
