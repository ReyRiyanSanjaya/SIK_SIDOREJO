		...
		<div class="container-lg">
			<div class="row justify-content-center">
				<div class="col-md-10 col-lg-8">
					...
					<iframe style="margin-left:30%;" src="https://embed.lottiefiles.com/animation/53451"></iframe>
					<!-- Divider -->
					<hr class="hr-sm bg-primary mt-6 mb-6 mx-auto">
					<!-- Text -->
					<p class="fs-lg text-center text-muted">
						Selamat anda berhak menerima Bantuan Sosial dari Universitas Medan Area
					</p>
