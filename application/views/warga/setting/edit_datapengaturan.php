		...
		<div class="container-lg">
			<div class="row align-items-center">
				<div class="col-md-6 col-xl-5 text-center text-md-start mt-md-n8" data-aos="fade-up">
					...
					<form action="<?php echo base_url('warga/edit_datau') ?>" method="post">
						...
						<div class="form-floating mb-3">
							...
							<label for="floatingPassword">Masukan Nama Anda</label>
						</div>
						<div class="form-floating mb-3">
							<input name="password" class="form-control" type="password">
							<label for="floatingInput">Masukan Baru Password Anda</label>
						</div>
						<button class="btn btn-primary-light lift mt-lg-4" type="submit">
							Ubah Sekarang
						</button>
					</form>
