			...
			<div class="row align-items-center">
				<div class="col-md-6 col-xl-5 text-center text-md-start mt-md-n8" data-aos="fade-up">
					...
					<h1 class="display-3 mb-4">
						Terimakasih <span class="text-primary-light text-underline-primary-light d-none d-lg-inline">
                        <br>
							<span data-typed='{"strings": ["Sudah Melengkapi Berkas yang anda ajukan"]}'></span></span><span class="text-primary-light text-underline-primary-light d-lg-none">Sudah Melengkapi Data</span>
					</h1>

					<!-- Text -->
					<p class="fs-lg">
						Silahkan menunggu daftar warga penerima BANSOS UMA.
					</p>

				</div>
				<div class="col-md-5 offset-md-1 offset-xl-2 align-self-start d-none d-md-block">

					<a data-bigpicture='{"imgSrc": "<?php echo base_url('berkas/') . $user['poto'] ?>"}' href="#" class="d-block mb-3 mb-md-0">
						<img class="img-fluid rounded-top-start-3 rounded-top-end-3 shadow-lg" src="<?php echo base_url('berkas/') . $user['poto'] ?>" alt="..." data-aos="fade-up" data-aos-delay="100">
					</a>
