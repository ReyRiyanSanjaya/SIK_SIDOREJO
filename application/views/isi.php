 		...
 		<div class="row align-items-center justify-content-between">
 			<div class="col-md-5 col-lg-4 pt-10 pt-md-12">
 				...
 				<div class="position-relative">
 					...
 					<!-- Decoration -->
 					<div class="position-absolute top-end text-warning mt-n8 me-n8">
 					...
 					<!-- Decoration -->
 					<div class="position-absolute bottom-start text-warning ms-n10 mb-8">
 						<svg width="185" height="186" viewBox="0 0 185 186" fill="none" xmlns="http://www.w3.org/2000/svg">
 							<circle cx="2" cy="2" r="2" fill="currentColor" />
 							<circle cx="22" cy="2" r="2" fill="currentColor" />
 							<circle cx="42" cy="2" r="2" fill="currentColor" />
 					...
 					<!-- Image -->
 					<img class="position-relative img-fluid rounded shadow-lg" data-jarallax-element="-50" src="<?php echo base_url('asset/gambar/pakde.png') ?>" alt="..." style="width: 200%; height: 200%;">
 				</div>
 			...
 			<div class="col-md-6 pt-8 pb-10 py-md-12 text-center text-md-start">
 				...
 				<!-- Text -->
 				<p>
 					ASIK SIDOREJO hadir untuk mempermudah masyarakat dalam pengerusan berkas, dan sebagai produk layanan digital dari Kelurahan sidorejo yang hadir untuk memajukan pelayanan administrasi kelurahan.
 				</p>
 ...
 <!-- SHAPE -->
 <div class="position-relative mt-md-n12">
 	<div class="shape shape-fluid-x shape-bottom text-white">
 		<div class="shape-img pb-9 mb-md-14">
 ...
 <!-- SHARED BACKGROUND -->
 <div class="bg-dark" style="background-image: url(assets/img/patterns/pattern-1.svg);">

 	<!-- STORIES -->
 	<section class="pt-12 pt-md-16 pb-10 pb-md-12">
 		<div class="container-lg">
 			<div class="row align-items-center justify-content-betwen mb-9">
 				<div class="col-md-5 text-center text-md-start">

 					<!-- Heading -->
 					<h2 class="display-4 text-white mb-4 mb-md-0">
 						Berita Terbaru Tentang Kelurahan SIDOREJO
 					</h2>
 				...
 				<div class="col-md-6 text-center text-md-start">
 					...
 					<p class="text-white mb-0">
 						TERWUJUDNYA SUMBER DAYA KELURAHAN YANG PROFESIONAL DALAM PELAYANAN MENUJU MASYARAKAT YANG SEJAHTERA, HUMANIS YANG RELIGIUS
 					</p>
 			...
 			<div class="row">
 				<div class="col-12">
 					...
 					<div class="flickity-viewport-visible mx-n4" data-flickity='{"cellAlign": "left", "imagesLoaded": true, "pageDots": false, "prevNextButtons": false, "contain": true}'>
 						<div class="col-12 px-4" style="max-width: 300px;">

 							<!-- Card -->
 							<div class="card card-sm rounded-top-start rounded-bottom-end lift">

 								<!-- Image  -->
 								<img class="card-img rounded-top-start" src="<?php echo base_url('asset/gambar/p1.png') ?>" alt="...">
 								...
 								<div class="card-body">
 									...
 									<!-- Text -->
 									<p class="fs-sm mb-4">
 										Photo bersama dengan Mahasiswa UMA yang hebat
 									</p>
 									...
 									<div class="d-flex align-items-center">
 										...
 										<div class="avatar avatar-xs">
 											<img class="avatar-img rounded-circle" src="<?php echo base_url('asset/gambar/default2.jpg') ?>" alt="...">
 										</div>
